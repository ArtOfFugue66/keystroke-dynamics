...
class TestReadDataset(unittest.TestCase):
    def test_make_pairs_for_user_fcn_genuine_pairs(self):
        """
        Test pairing.make_pairs_for_user() functionality for GENUINE pairs.
        ...
        expected = [
            (
                pd.DataFrame(
                    columns=['HOLD_LATENCY', 'INTERKEY_LATENCY',
                             'PRESS_LATENCY', 'RELEASE_LATENCY'],
    ...
    def test_make_pairs_for_user_fcn_impostor_pairs(self):
        """
        Test pairing.make_pairs_for_user() functionality for IMPOSTOR pairs.
    ...
    def test_make_batches_fcn(self):
        ...
        TODO: A batch should be a list of tuples.
        """
        # Arrange
